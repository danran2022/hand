...
#         loss = vanila_contrastive_loss(z_pro_nor, z_inverse_change_nor)
    ...
    torch.save(checkpoint, f'./outputs/SSKD/3/T_step1_test_SSKD_ch_loss/model/teacher_step1_{epoch + 1}.pth')
    ...
    with open('./outputs/SSKD/3/T_step1_test_SSKD_ch_loss/epoch_loss_list.txt', 'a') as file:
        file.write("%s\n" % epoch_loss)
